// Reusable Headers Panel Component
import { Terminal } from "lucide-react"

export default function HeadersPanel({ headers, darkMode, codeBg }) {
    return (
                ...
                <table className="w-full text-sm">
                    <thead>
                        <tr className={`border-b ${darkMode ? 'border-gray-700' : 'border-gray-300'}`}>
                            <th className="text-left py-2 pr-4 font-semibold text-blue-400 w-48">Header</th>
                            <th className="text-left py-2 font-semibold text-blue-400">Value</th>
                        </tr>
                    </thead>
                    <tbody>
